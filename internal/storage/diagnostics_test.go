...
func TestStorageDiagnosticKindsSurviveWrapping(t *testing.T) {
	for _, kind := range []string{"locked", "newer_schema", "foreign_database", "corrupt", "write_failed", "backup_failed", "migration_failed", "unreadable", "invalid_values", "commit_uncertain"} {
