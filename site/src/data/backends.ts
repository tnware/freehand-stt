...
const editorial = [
  ...
  { id: "whisper-cpp", short: "WC", summary: "A transcription profile for the native whisper.cpp HTTP server.", guide: "/docs/backends/whisper-cpp/", evidence: "Pinned source + contract fixtures", detail: "Native /inference uploads, server-loaded model, and /health checks. Completed microphone and file transcription; no file streaming." },
  { id: "vllm", short: "VL", summary: "Dedicated transcription and text-cleanup contracts for vLLM.", guide: "/docs/backends/vllm/", evidence: "v0.28.0 source + contract fixtures", detail: "Completed transcription, vLLM file streams, and text cleanup with output limits and reasoning-off controls. Model and template behavior still needs scoped live acceptance." },
